...
<head>
    ...
    <style>
        ...
        .status-valide { background-color: #198754; color: #fff; }
        .status-refuse { background-color: #dc3545; color: #fff; }
        .filter-container { background-color: #f8f9fa; padding: 20px; border-radius: 10px; margin-bottom: 20px; }
        ...
        .reservation-id { font-weight: bold; color: #0d6efd; }
    </style>
</head>
<body class="bg-light">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <c:if test="${res.adherant != null and res.adherant.personne != null}">
                                                <div class="fw-bold">${res.adherant.personne.nom} </div>
                                        ...
                                        <td>
                                            ...
                                            <c:if test="${statutActuel != null && statutActuel.nomStatut != null}">
                                                <c:choose>
                                                    <c:when test="${statutActuel.nomStatut eq 'En attente'}">
                                                        <span class="badge status-badge status-en-attente">
                                                            <i class="bi bi-clock"></i> En attente
                                                        </span>
                                                    </c:when>
                                                    <c:when test="${statutActuel.nomStatut eq 'Validé'}">
                                                        <span class="badge status-badge status-valide">
                                                            <i class="bi bi-check-circle"></i> Validé
                                                        </span>
                                                    </c:when>
                                                    <c:when test="${statutActuel.nomStatut eq 'Refusé'}">
                                        ...
                                        <td>
                                            <c:if test="${res.admin != null and res.admin.personne != null}">
                                                <div class="fw-bold">${res.admin.personne.nom}</div>
